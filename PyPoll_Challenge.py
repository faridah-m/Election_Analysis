...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (countyvotes > winning_countyvotes) and (countyvote_percentage > countywinning_percentage):
                    winning_countyvotes = countyvotes
    ...
    winning_county_summary = (
            ...
            f"Winning Vote County: {winning_countyvotes:,}\n"
            f"Winning County Vote Percentage: {countywinning_percentage:.1f}%\n"
            f"-------------------------\n")
